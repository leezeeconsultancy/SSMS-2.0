...
import { Plus, Search, Edit2, Trash2, Mail, Phone, X, Loader2 } from 'lucide-react';
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-700 mb-1">Work Hrs/Day *</label>
              ...
              {!editingId && (
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <select name="role" value={form.role} onChange={handleChange} className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-primary-500 focus:border-primary-500">
